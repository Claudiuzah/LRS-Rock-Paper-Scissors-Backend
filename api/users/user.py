...
@user_router.get("/profile", response_model=UserProfileStatistics, status_code=status.HTTP_200_OK)
async def get_user_profile_stats(
    ...
    if user_stats.total_games_multiplayer > 0:
        win_percentage_multiplayer = (user_stats.total_wins_multiplayer / user_stats.total_games_multiplayer) * 100
        loss_percentage_multiplayer = 100 - win_percentage_multiplayer
    else:
        win_percentage_multiplayer = 0
        loss_percentage_multiplayer = 0

    if user_stats.total_games_singleplayer > 0:
        win_percentage_singleplayer = (user_stats.total_wins_singleplayer / user_stats.total_games_singleplayer) * 100
    ...
    return UserProfileStatistics(
        ...
        total_games_multiplayer=user_stats.total_games_multiplayer,
        total_wins_multiplayer=user_stats.total_wins_multiplayer,
        total_points_multiplayer=user_stats.total_points_multiplayer,
        win_percentage_multiplayer=win_percentage_multiplayer,
        loss_percentage_multiplayer=loss_percentage_multiplayer,
        total_games_singleplayer=user_stats.total_games_singleplayer,
        total_wins_singleplayer=user_stats.total_wins_singleplayer,
        total_points_singleplayer=user_stats.total_points_singleplayer,
